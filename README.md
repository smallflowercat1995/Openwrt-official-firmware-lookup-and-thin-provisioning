...
### 1、解决openwrt内核版本不一致,报错: cannot find dependency kernel (= 5.10.115-1-19cc8260705cc8ea5062882916b83dcc)
    ...
    cat /etc/opkg/distfeeds.conf  | grep openwrt_core | awk '{print $3}'
    ...
    wget  "https://downloads.openwrt.org/snapshots/targets/armvirt/64/packages/kernel_${var}_aarch64_cortex-a53.ipk" -O kernel_${var}_aarch64_cortex-a53.ipk
